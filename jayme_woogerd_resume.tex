...
{\em Relevant Coursework: Data Structures, Machine Structure \& Assembly Language, Discrete Mathematics, Programming Languages, Algorithms, Advanced Functional Programming, Operating Systems.}
\smallskip

{\bf Bowdoin College, Brunswick, ME} \hfill {\em  May 2007} \\ 
Bachelor of Arts, Physics \& Astronomy, Classics \\
GPA 3.78, Graduated Cum Laude.  \smallskip \\
...
Programming Languages & C/C++, Python (Sikuli), HTML5/CSS3, some functional (Scheme)\\
Tools & Vim, Git, LaTeX
\end{tabular}
